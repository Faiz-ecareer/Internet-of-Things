...
const char* ssid = "ping";//Chane here your hostspot id
const char* password = "technahar";//change here your hotspot password
...
void loop() {
  ...
  client.println("<center><h2>Ashish</h2></center>");
